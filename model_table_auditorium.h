#ifndef MODEL_TABLE_AUDITORIUM_H
#define MODEL_TABLE_AUDITORIUM_H

#include "atablemodel.h"

class ModelTableAuditorium : public ATableModel {
private:
    void query_bind_values(QSqlQuery& query, const QVector<QVariant>& row) override;

public:
    ModelTableAuditorium();
...
#endif // MODEL_TABLE_AUDITORIUM_H
