#ifndef MODEL_TABLE_DISCIPLINE_H
#define MODEL_TABLE_DISCIPLINE_H

#include "atablemodel.h"

class ModelTableDiscipline : public ATableModel {
private:
    void query_bind_values(QSqlQuery& query, const QVector<QVariant>& row) override;
public:
    ModelTableDiscipline();
...
#endif // MODEL_TABLE_DISCIPLINE_H
